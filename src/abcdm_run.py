"""
abcdm_run.py is written for run ABCDM model
"""
...
from opinion_politic.methods.abcdm_model import ABCDM
from opinion_politic.config.abcdm_config import LOG_PATH, \
...
class RunModel:
    ...
    def init_model(data_set, use_pos):
        ...
        model = ABCDM(vocab_size=data_set.num_vocab_dict["num_token"],
