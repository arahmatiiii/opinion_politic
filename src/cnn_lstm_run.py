"""
cnn_lstm_run.py is written for run CNN model
"""
...
from opinion_politic.config.cnn_lstm_config import LOG_PATH, \
    ...
    HIDDEN_DIM, N_LAYERS, BIDIRECTIONAL, USE_AUG, TEST_USE_AUG, TEST_AUG_LOG_PATH, STEP_LR
...
class RunModel:
    ...
    def init_model(data_set, use_pos):
        ...
        """
        # create model
        model = CNNLSTM(vocab_size=data_set.num_vocab_dict["num_token"],
