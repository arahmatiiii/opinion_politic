"""
bert_lstm_run.py is written for run BErt Lstm model
"""
...
from opinion_politic.methods.bert_lstm_model import BertLstm
from opinion_politic.config.bert_lstm_config import LOG_PATH, \
    ...
    BIDIRECTIONAL, USE_AUG, TEST_USE_AUG, TEST_AUG_LOG_PATH, \
...
class RunModel:
    ...
    def init_model(data_set, use_pos):
        ...
        model = BertLstm(bert=bert_model, hidden_dim=HIDDEN_DIM, n_layers=N_LAYERS,
