"""
rcnn_run.py is written for run Rcnn model
"""
...
from opinion_politic.methods.rcnn_model import RCNN
from opinion_politic.config.rcnn_config import LOG_PATH, \
...
class RunModel:
    ...
    def load_data_set():
        ...
        data_set.load_data()
        print(data_set.embedding_dict["vocab_embedding_vectors"].shape)
        return data_set
    ...
    def init_model(data_set, use_pos):
        ...
        """
        # create model
        model = RCNN(vocab_size=data_set.num_vocab_dict["num_token"],
