"""
parsbert_data_util.py is writen for creating iterator and save field
"""
...
from opinion_politic.config.parsbert_config import TEXT_FIELD_PATH,\
    LABEL_FIELD_PATH, BATCH_SIZE, DEVICE, BERT_TOKENIZER, BERT_TYPE, FIX_LEN
...
class DataSet:
    ...
    def __init__(self, **kwargs):
        ...
        self.max_input_length = FIX_LEN#BERT_TOKENIZER.max_model_input_sizes[BERT_TYPE]
