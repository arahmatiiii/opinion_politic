...
from opinion_politic.config.cnn_config import LOG_PATH, TRAIN_DATA_PATH, TEST_DATA_PATH, \
    VALID_DATA_PATH, EMBEDDING_PATH, EMBEDDING_DIM, START_DROPOUT, MIDDLE_DROPOUT, FINAL_DROPOUT,\
    DEVICE,N_EPOCHS, MODEL_PATH, \
    N_FILTERS, FILTER_SIZES, USE_AUG, USE_POS
